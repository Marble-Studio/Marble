...
class SlotPlayer{
    ...
    setCoinsCount(count)
    {
        ...
        if (changed) 
        {
           ...
           // localStorage.setItem('mk_aqua_bl_amount', this.coins); // save coins
        }
    }
    ...
    loadCoins()
    {
       ...
       // amount = parseInt(localStorage.getItem('mk_aqua_bl_amount')) || this.defaultCoins; // load https://www.dynetisgames.com/2018/10/28/how-save-load-player-progress-localstorage/
...
class SlotControls
{
    constructor(scene, slotPlayer, linesData, lineColor, lineBetMaxValue, jackpotDefaultAmount)
    {
        ...
        saveScoreToFirebase(changeTotalBetEvent);
    ...
    setJackpotAmount(amount)
    {
        ...
        if (changed) 
        {
          ...
          //  localStorage.setItem('mk_aqua_jp_amount', this.jackpotAmount); // save https://www.dynetisgames.com/2018/10/28/how-save-load-player-progress-localstorage/
        }
    }
    ...
    loadJackpot()
    {
      ...
      //  amount = parseInt(localStorage.getItem('mk_aqua_jp_amount')) || this.jackpotDefaultAmount; // load https://www.dynetisgames.com/2018/10/28/how-save-load-player-progress-localstorage/
