class Game extends Phaser.Scene {
	...
	create(){
		...
		function addScore(amount) {
			score += amount; // Update in-game score
			if (score > bestscore) {
				bestscore = score; // Update best score if necessary
			}
			saveScoreToFirebase(amount); // Save only the incremental amount
			updateTextScore();
		}
