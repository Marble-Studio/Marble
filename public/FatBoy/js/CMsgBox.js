function CMsgBox(szText,oParentContainer){
    ...
    this._init = function (szText) {
        ...
        var oMsgOut = new CTLText(_oContainer, 
                    CANVAS_WIDTH / 2 - 250, 470, 500, 250, 
                    34, "center", "#000", PRIMARY_FONT, 1,
                    0, 0,
                    szText,
                    true, true, true,
                    false );
        oMsgOut.setOutline(3);
        ...
        _oButOk = new CGfxButton(CANVAS_WIDTH / 2, 830, s_oSpriteLibrary.getSprite('but_yes'), _oContainer);
