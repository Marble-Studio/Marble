...
function CLevelMenu(iLevels) {
    ...
    this._init = function () {
        ...
        _pStartPosSelect = {x: CANVAS_WIDTH / 2, y: CANVAS_HEIGHT_HALF - 240};
        ...
        var oTextLevel = new CTLText(_oContainer, 
                    ...
                    true, true, true,
                    false );
        oTextLevel.setShadow("#df7ac7",2,2,2);
    ...
    this._createNewLevelPage = function (iStartLevel, iEndLevel) {
        ...
        for (var i = iStartLevel; i < iEndLevel; i++) {
            var szNumLevel = (i + 1) > s_iLastLevel ? " " : i+1;
