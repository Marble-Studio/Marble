function CGame(oData) {
    ...
    this.onExit = function () {
        // Assuming _iScore holds the final score
        //saveScoreToFirebase(_iScore);  // Save the score to Firebase
    ...
    this.onDiePlayerSnake = function () {
        ...
        saveScoreToFirebase(_iBestScore);  // Save the score to Firebase
    };
