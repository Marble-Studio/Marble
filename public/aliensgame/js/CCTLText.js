// v2.6.1
/* 
    Bug fix: Text not refreshing after resize
*/
// V2.6
/* 
    Resizable text:
        setHorizontalSize: Set width and paddingH;
        setVerticalSize: Set height and paddingV;
        setSize: Set width, height, paddingH, paddingV;
*/
// V2.5
/* 
    Text is always created
*/
// V2.4
/*    
