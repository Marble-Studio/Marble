function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oSprite = s_oSpriteLibrary.getSprite('bg_level_2');
        ...
        var oLink = new createjs.Text(""," 44px "+PRIMARY_FONT, "#ffffff");
        oLink.y = 80;
        ...
        _oButExit = new CGfxButton(CANVAS_WIDTH/2, 750, oSprite, _oPanelContainer);
