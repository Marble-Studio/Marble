function CMenu(){
    ...
    this._init = function(){
        ...
        // Removed _oButCredits and its event listener to disable info button
        ...
        if (_fRequestFullScreen && screenfull.isEnabled){
            ...
            _pStartPosFullscreen = {x: CANVAS_WIDTH - oSprite.width/2 - 10, y: 10};
    ...
    this.unload = function(){
        ...
        // Comment out or remove this line to avoid trying to unload a non-existing button
        // _oButCredits.unload();
    ...
    this.refreshButtonPos = function() {
        ...
        // Remove or comment out this line as the credits button is removed
