...
const AdminRankings = () => {
  ...
  return (
    <>
      <button className="mb-4 px-4 py-2 bg-blue-500 text-white rounded" onClick={addUsersToLeaderBoard}>
        Update LeaderBoard
      </button>

      <div className="w-full flex flex-col space-y-3 pt-3">
        {leaderBoard
          .sort((a, b) => b.profitHour - a.profitHour) // Sort users by profitHour in descending order
          .map((user, index) => (
