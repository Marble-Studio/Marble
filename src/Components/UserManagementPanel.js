    ...
    <div className="w-full flex flex-col space-y-4 h-[100vh] scroller pt-4 overflow-y-auto pb-[150px]">
      <div className='w-full sm:w-[50%] flex flex-col gap-3'>
        ...
        <button onClick={handleSearch} 
         className="bg-[#ffffff] font-semibold text-[15px] rounded-[6px] w-full sm:w-[200px] h-fit px-4 py-3 text-[#000]">          
          Search
        </button>
      ...
      <div className="w-full sm:w-[50%] flex flex-col space-y-3">
        ...
        <button 
          ...
          disabled={loading}
          className="bg-[#ffffff] font-semibold text-[15px] rounded-[6px] w-full sm:w-[200px] h-fit px-4 py-3 text-[#000] mt-4"
        >
