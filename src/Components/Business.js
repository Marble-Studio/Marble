...
// }
    ...
    setTimeout(() => {
      setUserLevelsMarket((prevMarketLevels) =>
        prevMarketLevels.map((level, i) => (i === index ? newMarketLevel : level))
      );
      setTotalMarketProfit((prevTotalMarketProfits) =>
        prevTotalMarketProfits.map((profit, i) => (i === index ? newTotalMarketProfit : profit))
  ...
  return (
    <>
      {marketTeam.map((market, index) => {
        ...
        return (
          ...
          <div className="relative flex items-center pb-2 justify-center">
                ...
                {/* Lock icon logic has been removed */}
              </div>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <span className="flex items-center space-x-1">
                  ...
                  <span
                    className={`${currentMarketLevel === 0 ? 'text-secondary' : 'text-primary'} font-semibold text-[12px]`}
                  >
                    {currentMarketLevel === 0 ? <>+{nextMarketLevelData.profit}</> : <>{marketProfitsTotal}</>}
                  </span>
                </span>
              </div>
            </button>
      ...
      <div
        className={`${upgrading ? 'visible top-1' : 'invisible top-[-12px] ease-out'} ease-in transition-all duration-300 w-full flex absolute left-0 right-0 px-8`}
      >
        {upgradeStatus}
      </div>
              ...
              <div className="w-full flex taskbg rounded-tl-[40px] rounded-tr-[40px] mt-[2px] justify-center relative flex-col items-center space-y-3 p-4 pt-20 pb-10">
                ...
                <div className="w-full flex justify-center flex-col items-center">
                  <div className="w-[180px] h-[180px] rounded-[25px] flex items-center justify-center">
                    <img alt="claim" src={marketTeam[selectedUpgrade.index].icon} className="rounded-full" />
                  </div><br></br>
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex flex-1 items-center justify-center space-x-1">
                      ...
                      <div className="font-bold text-[13px] flex items-center">
                        +{formatNumber(selectedUpgrade.nextMarketLevelData.profit)}
                      </div>
                    </div>
                  </div>
