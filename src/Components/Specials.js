            ...
            setCongratsMessage(
                <div className="w-full flex justify-center flex-col items-center space-y-3">
                    ...
                    <p className="pb-6 text-[15px] w-full text-center">
                        Your claimed TON will be kept safe in your wallet till token launch. You can also swap your TON for more Marble tokens or other listed assets in the wallets menu.
                    </p>
                </div>
            );
